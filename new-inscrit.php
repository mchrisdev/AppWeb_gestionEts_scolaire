                ...
                if (isset($_POST['btnInscrit'])) {
                    if (
                        ...
                        if($serv->setVerifiEcolServeur($_POST['ecole']) == true)
                        {
                            ...
                            $serv->setInsert_Serveur($_SESSION['id_ecole'], $id_eleve, $_POST['name'], $_POST['festname'], $_POST['prenom'], $_POST['sexe'], $_POST['datenaiss'], $_POST['lieunaiss'], $_POST['nation']);
...
?>
                ...
                <head>
                    <title>CERM SCHOOL | Inscription</title>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                    ...
                                                    <div class="card-header">
                                                        <div class="row">
                                                        <form action="recherche-serveur.php?id=" method="get">
                                                            <div class="col-md-6">
                                                                <h5 class="card-header-text">Formulaire d'enregistrement</h5>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text" name="search" class="form-control" placeholder="Recherche de matricule eleve au serveur central">
                                                                <input type="hidden" name="id" value="<?php echo $user_donnees['token']; ?>" class="form-control">
                                                            </div>
                                                            <div class="col-md-2">
                                                    ...
                                                    <form method="POST" action="">
                                                        <?php 
                                                            if(isset($_GET['flash']) AND $_GET['flash']== 'erreur')
                                                            {
                                                                $message= '<label class="alert alert-danger btn-block">l`\'Eleve n\'existe pas dans le répertoire merci de vous inscrire !</label>';
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name" class="form-control" required id="" aria-describedby="emailHelp" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Postnom</label>
                                                                    <input type="text" name="festname" class="form-control" required id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Prénom</label>
                                                                    <input type="text" name="prenom" class="form-control" required id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Sexe</label>
                                                                    <select name="sexe" id="sexe" class="form-control" required id="">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" name="datenaiss" required class="form-control" id="">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="" class="form-control-label">Lieu de naissance</label>
                                                                    <input type="text" name="lieunaiss" required class="form-control" id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1"  class="form-control-label">Classe</label>
                                                                    <select name="classe" id="classe" required class="form-control" id="">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="option" id="option" required class="form-control" id="">
                                                                        <option value="">Selectionner</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="nation" required class="form-control" id="exampleInputPassword1" >
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Ecole de provinnace</label>
                                                                    <select name="ecole" id="ecole" required class="form-control" id="">
                                                                        <option value="">Selectionner</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="nom_tuteur" required class="form-control" id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Prénom du tuteur</label>
                                                                    <input type="text" name="prenom_tuteur" required class="form-control" id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Profession</label>
                                                                    <input type="text" name="profession" required class="form-control" id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Téléphone</label>
                                                                    <input type="text" name="phone_tuteur" required class="form-control" id="" >
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1" class="form-control-label">Adresse</label>
                                                                    <input type="text" name="adresse" required class="form-control" id="" >
                                                                </div>
                                                            </div>
