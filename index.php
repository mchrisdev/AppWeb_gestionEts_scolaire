...
{
	$user->setVerifyUser($_POST['name'], $_POST['password']);
...
<html lang="fr">
<head>
	<title>CERM SCHOOL | Authentification</title>
	<!-- Meta -->
	<meta charset="utf-8">
					...
					<form class="md-float-material" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="md-input-wrapper">
									<input type="text" name="name" class="md-form-control" />
						...
						<div class="row">
							<div class="col-xs-10 offset-xs-1">
								<button type="submit" name="btnconnexion" id="btnconnexion" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Connexion</button>
							</div>
						</div>
